...
from PG_matching_RL_PPO import _create_batch_data
import torch_geometric
torch_geometric.seed_everything(1)

dataset_file_name = f'/home/kli16/esm_NSUBS_RWSE_LapPE/esm/data/{FLAGS.dataset}/{FLAGS.dataset}_trainset_{FLAGS.dataset_type}_noiseratio_5.0_n_16_32_num_01_31_LapPE.pkl'
...
lr_decay = False
checkpoint_path = f'/home/kli16/esm_NSUBS_RWSE_LapPE/esm/ckpt_RL/2024-03-25_00-07-28/checkpoint_38000.pth'
...
class PPO:
    ...
    def update(self):
        ...
        batch, dataloader = _create_batch_data_parallel(pre_processed_li,old_logprobs,advantages,rewards,old_states,old_actions,batch_size=self.batch_size)
