...
class PPO:
    ...
    def update(self):
        ...
        batch, dataloader = _create_batch_data_parallel(pre_processed_li,old_logprobs,advantages,rewards,old_states,old_actions,len(old_states)//20)
        ...
        for _ in range(self.K_epochs):
            ...
            for step, batch in enumerate(dataloader):
                ...
                loss = (loss_policy + loss_value + loss_dist_entropy)/32
                loss.mean().backward()
...
update_timestep = 1 * 64   # update policy every n timesteps
