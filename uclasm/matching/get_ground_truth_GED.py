...
def create_batch(dataset_name,noiseratio):
    ...
    if dataset_name == 'SYNTHETIC':
        subgraph_node_num = '10_20'
    if dataset_name == 'EMAIL':
        subgraph_node_num = '16_32'
    if dataset_name == 'MSRC_21':
        subgraph_node_num = '16_32'

    dataset_file_name = f'/home/kli16/ISM_custom/esm_NSUBS_generaldistance/esm/data/{dataset_name}/{dataset_name}_trainset_dense_noiseratio_{noiseratio*100}_n_{subgraph_node_num}_num_01_31_RWSE.pkl'   # 获取文件名
    matching_file_name = f'/home/kli16/ISM_custom/esm_NSUBS_generaldistance/esm/data/{dataset_name}/{dataset_name}_dataset_dense_n_{subgraph_node_num}_num_01_31_matching.pkl'   # 获取文件名
    ...
    for episode in range(5000):
        ...
        gid1 = state_init.g1.graph['gid']
        gid2 = state_init.g2.graph['gid']
        matching = matchings[(gid1,gid2)]
        cost = calculate_cost(state_init.g1,state_init.g2,matching)
        costs.append(cost)
