...
parser.add_argument('--noiseratio', type=int, default=0)
# do_test = True
do_test = False
...
parser.add_argument('--ckptID', type=str, default='20000')
...
# if dataset == 'AIDS':
#     graphgps_config_path = 'AIDS_GateGCN_RSWE.yaml'
# else:
#     graphgps_config_path = 'email_GateGCN_RSWE.yaml'
# graphgps_config_path = f'{dataset}_GateGCN_RSWE.yaml'
graphgps_config_path = f'{dataset}_GateGCN_LapPE_RWSE.yaml'
parser.add_argument('--graphgps_config_path', default=graphgps_config_path)


lr= 0.000001
parser.add_argument('--lr',type=float, default=lr)
parser.add_argument('--modelID', default='2024-04-12_00-00-44')
parser.add_argument('--order_Gq',type=str, default='RI')
parser.add_argument('--dataset_type',type=str, default='dense')
...
parser.add_argument('--sys_path', type=str, default=sys_path)
...
parser.add_argument('--train_mode', type=str, default='RL')
...
if FLAGS.train_mode == 'RL':
    FLAGS.ckpt_folder = 'ckpt_RL'
else:
    FLAGS.ckpt_folder = 'ckpt_imitationlearning'
# FLAGS.graphgps_config_path = f'{FLAGS.dataset}_GateGCN_RSWE.yaml'
...
FLAGS.dvn_config = {
    ...
    'decoder_policy': {
        ...
        'similarity_decoder': {
            ...
            'mlp_out_dims': [int(FLAGS.d_enc*2), 32, 16, 8, 1],
