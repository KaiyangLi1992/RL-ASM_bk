...
from NSUBS.model.OurSGM.utils_our import get_accum_reward_from_start, correspondence_li, transform_u, transform_v_li, split_tensor
...
class BilinearDecoder(torch.nn.Module):
    ...
    def forward(self, pyg_data_q, pyg_data_t, u, v_li, g_emb):
        ...
        sim = split_tensor(sim.view(-1), v_corres)
